...
{
    using Modules.pokegame.poketypes;
    class Pokegame : DiscordModule
    {
        ...
        public override void Install(ModuleManager manager)
        {
            manager.CreateCommands("", cgb =>
            {
                ...
                .Do(async e =>
                {
                    ...
                    PokemonTypes.PokeType usertype = getPokeType(e.User.Id);
                    ...
                    //get target type
                    PokemonTypes.PokeType targetType = getPokeType(target.Id);
                    //generate damage
        ...
        private PokemonTypes.PokeType getPokeType(ulong id)
        {
...
namespace NadekoBot.Modules.pokegame.poketypes
{
