...
- Windows 8 or later, 64 bit. If you have Windows 7, use the [Docker Guide](https://nadekobot.readthedocs.io/en/latest/guides/Docker%20Guide/). If you have a 32 bit machine, use the [From Source](https://nadekobot.readthedocs.io/en/latest/guides/From%20Source/) guide.   
